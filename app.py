        ...
        if not api_key:
            ...
            with st.spinner("Analyzing structural motifs..."):
                try:
                    ...
                    2. Identify any notable motifs (e.g., long stretches of 'H' could be transmembrane domains; alternating 'E' and 'C' could be beta-barrels).
                    ...
                    # 4. Generate and display the response using the new syntax and available model
